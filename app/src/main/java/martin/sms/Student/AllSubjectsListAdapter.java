...
public class AllSubjectsListAdapter extends BaseAdapter {

    Activity activity;
    List<SelectedSubject> users;
    LayoutInflater inflater;

    public AllSubjectsListAdapter(Activity activity) {
        this.activity = activity;
    }

    public AllSubjectsListAdapter(Activity activity, List<SelectedSubject> users) {
        this.activity = activity;
        this.users = users;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        AllSubjectsListAdapter.ViewHolder holder = null;

        if (view == null){

            view = inflater.inflate(R.layout.activity_all_subjects_list_item, viewGroup, false);

            holder = new AllSubjectsListAdapter.ViewHolder();
            ...
            holder = (AllSubjectsListAdapter.ViewHolder)view.getTag();
